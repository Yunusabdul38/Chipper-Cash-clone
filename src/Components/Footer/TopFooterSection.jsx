function TopFooterSection() {
  return (
    <div className="h-96 rounded-3xl justify-center items-center flex flex-col gap-4 border  mt-[-400px] bg-[#fff]  w-[100%] mx-auto px-12 py-8 md:px-20 border-[#c1c4e5]">
      <h1 className="text-[#1b0a2d] font-semibold text-2xl text-center md:text-4xl">
        In an instant send support, feed a passion, or strengthen a bond
      </h1>
      <div className="grid md:grid-cols-2 items-center gap-2">
        <div className="flex gap-2 bg-[#202654] rounded-[15px] py-2 px-4 text-[#fff] w-52 hover:bg-[#393589] cursor-pointer">
          <img
